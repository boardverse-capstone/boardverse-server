...
namespace BoardVerse.Services.IServices
{
    public interface ILeaderboardService
    {
        ...
        /// </summary>
        Task<KarmaLeaderboardDto> GetKarmaLeaderboardAsync(int limit = 100, CancellationToken cancellationToken = default);

        /// <summary>
        /// K-06: Global elo leaderboard ordered by GlobalElo DESC.
        /// </summary>
        Task<EloLeaderboardDto> GetEloLeaderboardAsync(int limit = 100, CancellationToken cancellationToken = default);

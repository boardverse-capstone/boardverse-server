...
public class CafeRepositoryAvailableSeatsTests : IDisposable
{
        ...
        ReservationStatus status)
    {
        ...
        var reservation = new Reservation
        {
            ...
            PlayDate = playDate,
            TimeSlot = timeSlot,
            ScheduledStartTime = playDate.ToDateTime(timeSlot.GetStartTime()),
            ScheduledEndTime = playDate.ToDateTime(timeSlot.GetEndTime()),
            PreferredStartTime = timeSlot.GetStartTime(),
            PreferredEndTime = timeSlot.GetEndTime(),

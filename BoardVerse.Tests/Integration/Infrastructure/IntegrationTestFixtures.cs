...
public static class IntegrationTestFixtures
{
    ...
    public static Guid DemoPlayer4UserId { get; internal set; }
    ...
    public static void GenerateUniqueIds()
    {
        ...
        DemoPlayer4UserId = Guid.Parse($"{prefix}-0007-0007-0007-000000000007");
        DemoMatchLobbyId = Guid.Parse($"{prefix}-0008-0008-0008-000000000008");
        DemoKarmaLobbyId = Guid.Parse($"{prefix}-0009-0009-0009-000000000009");
        DemoPosTableId = Guid.Parse($"{prefix}-000A-000A-000A-00000000000A");
        DemoCatanInventoryId = Guid.Parse($"{prefix}-000B-000B-000B-00000000000B");

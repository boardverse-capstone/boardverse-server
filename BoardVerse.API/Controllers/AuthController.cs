...
namespace BoardVerse.API.Controllers
{
    ...
    public class AuthController : BaseApiController
    {
        ...
        /// <summary>
        /// Đăng ký tài khoản người dùng mới vào hệ thống BoardVerse.
        /// </summary>
        ...
        /// <summary>
        /// Xác thực tài khoản và tạo token đăng nhập cho người dùng.
        /// </summary>
        ...
        /// <summary>
        /// Đăng nhập bằng tài khoản Google và phát hành token truy cập.
        /// </summary>
        /// <param name="request">Thông tin Google ID token.</param>
        /// <response code="200">Đăng nhập Google thành công.</response>
        /// <response code="401">Google token không hợp lệ hoặc thiếu dữ liệu bắt buộc.</response>
        ...
        /// <summary>
        /// Gia hạn access token bằng refresh token hợp lệ.
        /// </summary>
        ...
        /// <summary>
        /// Thu hồi refresh token của người dùng để kết thúc phiên đăng nhập.
        /// </summary>
        ...
        /// <summary>
        /// Gửi mã xác minh email đến địa chỉ đã đăng ký của người dùng.
        /// </summary>
        ...
        /// <response code="500">Không gửi được email.</response>
        ...
        /// <summary>
        /// Xác thực email của người dùng bằng mã xác minh đã nhận.
        /// </summary>
        ...
        /// <summary>
        /// Tạo yêu cầu đặt lại mật khẩu và gửi mã reset đến email người dùng.
        /// </summary>
        ...
        /// <response code="403">Email chưa được xác minh.</response>
        /// <response code="404">Không tìm thấy người dùng theo email.</response>
        ...
        /// <summary>
        /// Đặt lại mật khẩu bằng mã xác minh đặt lại mật khẩu.
        /// </summary>
        ...
        /// <response code="400">Mật khẩu mới không hợp lệ hoặc tài khoản không có mật khẩu nội bộ.</response>
        ...
        /// <summary>
        /// Liên kết tài khoản Google với tài khoản BoardVerse hiện có.
        /// </summary>
        ...
        /// <response code="401">Google token không hợp lệ.</response>

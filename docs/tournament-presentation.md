...
| WinnerKarmaBonus | +5 | -100/+100 | Karma thưởng cho nhà vô địch |
| FinalistKarmaBonus | +3 / +2 / +1 | -100/+100 | Karma cho Top 2-4 (giảm tuyến tính) |
| NoShowKarmaPenalty | -10 | -100/+100 | Phạt bùng kèo |

### 🎁 Karma economics

| Outcome | Karma change | Reason |
|---|---|---|
| 🏆 Winner | **+5** | Khuyến khích thi đấu nghiêm túc (BR: max Karma = 100) |
| 🥈🥉 Finalist (Top 2-4) | **+3 / +2 / +1** | Phần thưởng tham dự Final (giảm tuyến tính theo rank) |
| 👻 No-show | **−10** | Phạt bùng kèo, dò xét lịch sử |
